      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{totalViews}</p>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{totalClicks}</p>
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{ctr}%</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
            ...
            <div className="flex w-full sm:w-auto bg-gray-100 dark:bg-slate-700 rounded-lg p-1">
              {['7d', '30d', '90d'].map((r) => (
                <button
                  key={r}
                  onClick={() => setRange(r)}
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          ...
          <div className="h-64 md:h-80 w-full min-w-0">
            ...
            <div className="flex justify-center gap-4 mt-4 flex-wrap">
              {stats.devices.map((entry: any, index: number) => (
                <div key={index} className="flex items-center text-xs sm:text-sm text-gray-500 dark:text-gray-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
              <thead>
                <tr>
                  <th className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Link</th>
                  <th className="px-4 md:px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Clicks</th>
                </tr>
              </thead>
                  ...
                  <tr key={i}>
                    <td className="px-4 md:px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                      <div className="flex flex-col">
                        <span className="font-medium truncate max-w-[150px] sm:max-w-[200px]">{link.title}</span>
                        <span className="text-xs text-gray-500 truncate max-w-[150px] sm:max-w-[200px]">{link.url}</span>
                      </div>
                    </td>
                    <td className="px-4 md:px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 text-right">
                      {link.clicks}
                    </td>
                  </tr>
                ))}
        ...
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-lg shadow border border-gray-200 dark:border-slate-700">
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
            <thead>
              <tr>
                <th className="px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Source</th>
                <th className="px-4 md:px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Visitors</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
