...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateUsername(formData.username)) {
      setError('Username must be 3-20 characters and contain only letters, numbers, and hyphens');
      setIsLoading(false);
      return;
    }
  ...
  return (
    <div className="bg-gradient-to-br from-slate-800 to-slate-900 shadow-2xl border border-purple-500/20 rounded-lg p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 mt-2">Join Pholio.Links today</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">
            Your profile will be available at {formData.username}.pholio.link
          </p>
        </div>
